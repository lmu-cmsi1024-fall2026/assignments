...
| Category | Points |
| -------- | -----: |
| Expected content | 12 points total |
| • Brief description of a past programming project | 2 points |
| • Navigation of a past programming project | 5 points |
| • Navigation of a programming language installation | 5 points |
| Proficiencies to demonstrate | 38 points total |
| • Moving around folders (`cd` etc.) | 6 points |
| • Listing files and showing information about them (`ls` and its various options) | 7 points |
| • Displaying text files (`more`/`less` and keyboard controls within) | 7 points |
| • Using <kbd>tab</kbd> autocomplete to save on typing | 5 points |
| • Locating where programs reside (`which`) | 3 points |
| • Using command history to save on typing (arrow keys, <kbd>control</kbd>-<kbd>r</kbd>, etc.) | 5 points |
| • Editing the current command (moving back and forth, making changes) | 5 points |
